...
()=>{
    ...
    async ()=>{
        ...
        const ok1 = await facade.query(AppConst.UPGRADE_BUILDING, {cityID: ATLANTIS().id, id:1});
    ...
    async ()=>{
        ...
        const atlantis = cityRepo.getOneBy('id', ATLANTIS().id);
        const ok1 = await facade.query(AppConst.UPGRADE_BUILDING, {cityID: ATLANTIS().id+ 100, id: 1, freely:true});
